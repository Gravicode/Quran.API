...
namespace QFE.BLL
{
    public class DataContext : DbContext
    {
        ...
        public DbSet<quran_text> qurantexts { get; set; }
        ...
        public static AyahData getVerse(int Surah, int Ayah)
        {
            ...
            try
            {
                ...
                using (var context = new DataContext())
                {
                    ...
                    SelAyah = (from a in context.qurantexts
        ...
        public static ObservableCollection<AyahData> getVerses1(int Surah, int LangId = 11,int verseSize=30)
        {
            ...
            try
            {
                ...
                using (var context = new DataContext())
                {
                    ...
                    //get quran
                    var quranteks = (from a in context.qurantexts
                               where a.sura == Surah
...
where a.sura={1} and b.langid={2}", lng.lang, Surah, LangId);
        ...
        public static int getSurahCount(int Surah)
        {
            try
            {
                ...
                using (var context = new DataContext())
                {
                    var SelAyah = (from a in context.qurantexts
                                   where a.sura == Surah
                                   select a).Count();
                    return SelAyah;
                }
        ...
        */
        ...
        public static void ReadQuranWithLinq()
        {
            try
            {
                ...
                using (var context = new DataContext())
                {
                    var Data = (from a in context.qurantexts
                                where a.sura==2
                            select a).ToList();
                }
                connection.Close();
